...
let delay;
let car = ["corolla", "yaris", "fortuner", "rush", "auris", "chr"];
let x;
...
function showSlides2(v){
    ...
    let h = document.getElementById(car[y]).height;
    document.getElementById(cars[m]).style.height='auto';
    document.getElementById(cars[y]).style.height=h+'px';
    let i;
