...
//Changing home picture
let body_width;
function wallpaper(){
    body_width = document.getElementById("footer_img").width;
    if(body_width<=1000){
        document.getElementById("wallpaper").src="Images/Mustang wallpaper (mobile).jpg";
    }else{
        document.getElementById("wallpaper").src="Images/Mustang wallpaper.jpg";
    }
}
setInterval(wallpaper, 10);
//Changing home picture